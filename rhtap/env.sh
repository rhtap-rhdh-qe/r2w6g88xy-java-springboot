...
export IMAGE_URL=${IMAGE_URL-rhtap-quay-quay-rhtap-quay.apps.rosa.kx-d9d993e7e2.sy05.p3.openshiftapps.com/rhtap/rhtap-qe:$CI_TYPE-$TAG}
...
export REKOR_HOST=${REKOR_HOST-https://rekor-server-rhtap-tas.apps.rosa.kx-d9d993e7e2.sy05.p3.openshiftapps.com}
...
export TUF_MIRROR=${TUF_MIRROR-https://tuf-rhtap-tas.apps.rosa.kx-d9d993e7e2.sy05.p3.openshiftapps.com}
